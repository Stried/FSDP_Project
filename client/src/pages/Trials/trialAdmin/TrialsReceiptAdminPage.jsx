          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-green-400 dark:bg-green-500 dark:text-black">
              <tr>
                ...
                <th
                  scope="col"
                  onClick={() => onSortChange("dateOfTrial")}
                  class="px-6 py-3"
                >
                  <div class="flex items-center">
                    Date of Trial
                ...
                <th
                  scope="col"
                  onClick={() => onSortChange("faultResolve")}
                  class="px-6 py-3"
                >
                  <div class="flex items-center">
                    Fault
                ...
                <th
                  scope="col"
                  onClick={() => onSortChange("emailAccount")}
                  class="px-6 py-3"
                >
                  <div class="flex items-center">
                    Email
                ...
                <th
                  scope="col"
                  onClick={() => onSortChange("trialStatus")}
                  class="px-6 py-3"
                >
                  <div class="flex items-center">
                    Status
                ...
                return (
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="pl-0 pr-4 py-4 text-right">
                      ...
                      <Modal
                        dismissible
                        show={openModals[i] === true} // Use the separate state for the current row's modal
                        onClose={() => toggleModal(i)} // Call the toggleModal function with the index of the current row
                      >
                        <Modal.Header>Trial Receipt Deletion</Modal.Header>
                        <Modal.Body>
