...
const SideNav = ({ isOpen }) => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full w-64 bg-gray-900 transition-transform duration-500 transform ${
...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      >
        <a href="#" class="flex items-center pl-11 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ">
        Accordion
        </a>
      </button>
      </ul>
